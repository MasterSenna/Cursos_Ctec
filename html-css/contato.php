...
$mailer->Username = 'contato@sandromir.com'; // SMTP username
$mailer->Password = 'Aula2022@';    // SMTP password
// email do destinatario
$address = "contato@sandromir.com";

//$mailer->SMTPDebug = 1;
$corpoMSG = "<strong>Nome:</strong> $nome<br> <strong>Assunto:</strong> $assunto<br> <strong>Mensagem:</strong> $mensagem";
...
$mailer->From = 'contato@sandromir.com';
$mailer->Sender = 'contato@sandromir.com';
$mailer->FromName = "Formulário de Contato - Senna 18"; // Seu nome
// assunto da mensagem
